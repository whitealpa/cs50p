...
from data import (
    ...
    add_task, delete_task, move_task,
    clear_board
)
...
@app.command(short_help="Move a task from \'Do\' to \'Doing\'")
def doing(task_id: int):
    """
...
@app.command(short_help="Move a task from \'Doing\' to \'Done\'")
